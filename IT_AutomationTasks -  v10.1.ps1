...
$MainFormIntroduction.Font                     = 'Microsoft Sans Serif,10,style=bold'
...
Function MainForm-MouseBehavior{
 ...
 Switch ($Action)
    {
        "MouseHover-Introduction" {$MainFormIntroduction.ForeColor      = "#f79d04";$MainFormIntroduction.Font      = 'Microsoft Sans Serif,11,style=Bold' ;$MainForm.Cursor="Hand"}
        "MouseHover-UserAction"   {$MainFormLabelUserAction.ForeColor   = "#f79d04";$MainFormLabelUserAction.Font   = 'Microsoft Sans Serif,11,style=Bold' ;$MainForm.Cursor="Hand"}
        "MouseHover-AssetsAction" {$MainFormLabelAssetsAction.ForeColor = "#f79d04";$MainFormLabelAssetsAction.Font = 'Microsoft Sans Serif,11,style=Bold' ;$MainForm.Cursor="Hand"}
        "MouseHover-summary"      {$MainFormLabelsummary.ForeColor      = "#f79d04";$MainFormLabelsummary.Font      = 'Microsoft Sans Serif,11,style=Bold' ;$MainForm.Cursor="Hand"}
        "MouseLeave-Introduction" {$MainFormIntroduction.ForeColor      = "#000000";$MainFormIntroduction.Font      = 'Microsoft Sans Serif,10'            ;$MainForm.Cursor="Default" }
        "MouseLeave-UserAction"   {$MainFormLabelUserAction.ForeColor   = "#000000";$MainFormLabelUserAction.Font   = 'Microsoft Sans Serif,10'            ;$MainForm.Cursor="Default"}
        "MouseLeave-AssetsAction" {$MainFormLabelAssetsAction.ForeColor = "#000000";$MainFormLabelAssetsAction.Font = 'Microsoft Sans Serif,10'            ;$MainForm.Cursor="Default"}       
        "MouseLeave-summary"      {$MainFormLabelsummary.ForeColor      = "#000000";$MainFormLabelsummary.Font      = 'Microsoft Sans Serif,10'            ;$MainForm.Cursor="Default"}
    }
$Global:Action="No"
 }
...
#**************************************************
$MainFormIntroduction.Add_MouseHover({  $Action="MouseHover-Introduction";MainForm-MouseBehavior -Action $Action
})

$MainFormIntroduction.Add_MouseLeave({ $Action="MouseLeave-Introduction";MainForm-MouseBehavior -Action $Action
if ($FormStartingPoint = "Started" ){$MainFormIntroduction.Font = 'Microsoft Sans Serif,10,style=bold'}
})

$MainFormIntroduction.Add_Click({ 
Write-Host "Introduction clicked" 
 })
#**************************************************

$MainFormLabelUserAction.Add_MouseHover({  $Action="MouseHover-UserAction";MainForm-MouseBehavior -Action $Action
})

$MainFormLabelUserAction.Add_MouseLeave({ $Action="MouseLeave-UserAction";MainForm-MouseBehavior -Action $Action
})

$MainFormLabelUserAction.Add_Click({ 
Write-Host "UserAction clicked"  
})
#**************************************************

$MainFormLabelAssetsAction.Add_MouseHover({  $Action="MouseHover-AssetsAction";MainForm-MouseBehavior -Action $Action
})

$MainFormLabelAssetsAction.Add_MouseLeave({ $Action="MouseLeave-AssetsAction";MainForm-MouseBehavior -Action $Action
})

$MainFormLabelAssetsAction.Add_Click({ 
Write-Host "AssetsAction clicked"  
})
#**************************************************

$MainFormLabelsummary.Add_MouseHover({  $Action="MouseHover-summary";MainForm-MouseBehavior -Action $Action
})

$MainFormLabelsummary.Add_MouseLeave({ $Action="MouseLeave-summary";MainForm-MouseBehavior -Action $Action
})

$MainFormLabelsummary.Add_Click({ 
Write-Host "summary clicked"  
})
#**************************************************
