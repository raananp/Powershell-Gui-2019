...
Function Create-Progressbar{   
    ...
    $MainFormProgressbar.width              = 130    
    $MainFormProgressbar.height             = 10
    $MainFormProgressbar.location           = New-Object System.Drawing.Point(5,250)       
...
Function OnBoarding-SubMenu{ 
    ...
    $MainFormProgressbar.Increment(+80)
    $MainFormPanel1.controls.AddRange(@($OnBoardingTitle,$OnBoardinglabelEnterUserFirstName,$OnBoardinglabelEnterUserFirstNameTextBox,$OnBoardinglabelEnterUserLastName,$OnBoardinglabelEnterUserLastNameTextBox,$OnBoardinglabelEnterUserName,$OnBoardinglabelEnterUserNameTextBox,$OnBoardinglabelEnterDescriptionTitle,$OnBoardinglabelEnterDescriptionTitleTextBox)) 
}
